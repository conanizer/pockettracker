...
android {
    ...
    defaultConfig {
        ...
        // 920 = v0.9.2, 930 = v0.9.3, 940 = v0.9.4; next: 950, … 1000 = 1.0.0). F-Droid's Tags
        // update check and the fastlane changelog filename (changelogs/<versionCode>.txt) both need
        // a literal value, and it outranks any commit-count build ever sideloaded.
