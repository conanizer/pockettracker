...
data class TrackerScreenParams(
    ...
    // Global status overlay (visualizer header): instrument-first, tracker fallback.
    val statusMessage: String,
    val statusSuccess: Boolean,
    val poolCursorColumn: Int = 0,
    val instrumentFromPool: Boolean = false,
    val fileBrowserState: FileBrowserModule.State? = null,
    val sampleEditorState: SampleEditorState? = null,
    ...
    val sendPeaks: FloatArray = FloatArray(4),
    ...
    val eqEditorState: EqEditorState = EqEditorState(),
    val eqSpectrumData: FloatArray? = null,
    val themeEditorState: ThemeEditorState = ThemeEditorState(),
...
private fun TrackerScreen(params: TrackerScreenParams, modifier: Modifier = Modifier) {
    ...
    Box(modifier = overlayModifier) {
        PixelPerfectTracker(
            ...
            statusSuccess = params.statusSuccess,
            poolCursorColumn = params.poolCursorColumn,
            instrumentFromPool = params.instrumentFromPool,
            ...
            autosaveResumeAuto = params.autosaveResumeAuto,
